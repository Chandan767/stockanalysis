...
import { Search, Bell, Activity, ArrowLeft } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = (props: HeaderProps) => {
  ...
  return (
    <header className="h-16 border-b border-slate-200 bg-white/90 backdrop-blur-md px-6 flex items-center justify-between sticky top-0 z-30 shadow-sm select-none">
      <div className="flex items-center space-x-4 flex-1 max-w-2xl">
        ...
        <div className="relative w-full">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-slate-100 border border-slate-200 rounded-lg text-sm text-slate-900 placeholder-slate-500 focus:outline-none focus:bg-white focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-colors font-medium select-text"
          />
        </div>
      </div>
