...
import { Search, Bell, Activity, ArrowLeft, Menu } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = (props: HeaderProps) => {
  const { onBackToHub, showBackHub, onToggleMobileSidebar } = props;
      ...
      <div className="flex items-center space-x-2 sm:space-x-4 flex-1 max-w-2xl">
        ...
        {showBackHub && onBackToHub && (
          ...
          >
            ...
            <span className="hidden xs:inline">4 AI Agents Hub</span>
